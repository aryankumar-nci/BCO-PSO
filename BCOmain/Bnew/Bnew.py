...
class BacterialColonyOptimization:
    def __init__(self, fitness_function, bounds, num_bacteria=30, num_iterations=100,
        ...
        """
        Initialize BCO algorithm parameters
        :param fitness_function: callable function to minimize
        :param bounds: tuple (lower_bound, upper_bound) or array of per-dimension bounds
        :param num_bacteria: population size
        :param num_iterations: total iterations
        :param C_min, C_max, n: chemotaxis step size control
        :param reproduction_interval: interval for reproduction
        :param migration_interval: interval for migration
        :param migration_prob: migration probability per bacterium
        """
